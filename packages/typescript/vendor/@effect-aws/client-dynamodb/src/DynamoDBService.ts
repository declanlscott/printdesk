...
export interface DynamoDBService$ {
  ...
  describeEndpoints(
    ...
    options?: HttpHandlerOptions,
  ): Effect.Effect<DescribeEndpointsCommandOutput, Cause.TimeoutError | SdkError>;
  ...
  listImports(
    ...
    options?: HttpHandlerOptions,
  ): Effect.Effect<ListImportsCommandOutput, Cause.TimeoutError | SdkError | LimitExceededError>;
 ...
 * @category models
 */
export class DynamoDBService extends Context.Service<DynamoDBService, DynamoDBService$>()(
  "@effect-aws/client-dynamodb/DynamoDBService",
) {
  public static readonly defaultLayer = Layer.effect(this, makeDynamoDBService).pipe(
    Layer.provide(Instance.layer),
  );
  public static readonly layer = (config: DynamoDBService.Config) =>
