...
import { OrderObjectMetadataMutations } from "../../orders/objects/mutations";
...
export const makeService = Effect.gen(function* () {
  ...
  return new Mutation.Dispatcher({ handlerRegistry: MutationHandlers.registry })
