...
import { OrderObjectMetadataPolicies } from "../../../orders/client/objects/policies";
...
export const makeService = Effect.gen(function* () {
  ...
  return new Policy.Dispatcher({ handlerRegistry: PolicyHandlers.registry })
    ...
    .policy(orderObjectMetadata.isCustomer)
    .policy(orderObjectMetadata.isManager)
    .policy(orderObjectMetadata.isCustomerOrManager)
    .policy(orderObjectMetadata.isManagerAuthorized)
