...
export type CapacityProviderLimitExceededError =
  TaggedException<CapacityProviderLimitExceededException>;
...
export type DurableExecutionAlreadyStartedError =
  TaggedException<DurableExecutionAlreadyStartedException>;
...
export type FunctionVersionsPerCapacityProviderLimitExceededError =
  TaggedException<FunctionVersionsPerCapacityProviderLimitExceededException>;
...
export type ProvisionedConcurrencyConfigNotFoundError =
  TaggedException<ProvisionedConcurrencyConfigNotFoundException>;
...
export type SerializedRequestEntityTooLargeError =
  TaggedException<SerializedRequestEntityTooLargeException>;
...
export type SnapStartRegenerationFailureError =
  TaggedException<SnapStartRegenerationFailureException>;
export type SnapStartTimeoutError = TaggedException<SnapStartTimeoutException>;
export type SubnetIPAddressLimitReachedError =
  TaggedException<SubnetIPAddressLimitReachedException>;
