...
import { DeliveryOptionsRepository, DeliveryOptionsSyncRepository } from ".";
...
export const repositoryLayer = makeRepository.pipe(Layer.effect(DeliveryOptionsRepository));
