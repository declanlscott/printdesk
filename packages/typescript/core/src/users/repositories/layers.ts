...
import type { ActiveUser, User, UsersTable } from "../sql";
...
export const repositoryLayer = makeRepository.pipe(Layer.effect(UsersRepository));
...
export const syncRepositoryLayer = makeSyncRepository.pipe(Layer.effect(UsersSyncRepository));
