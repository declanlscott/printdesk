...
export namespace Models {
  export const syncTables = Array.make(
    ...
    OrderObjectMetadataContract.Table,
  ...
  export const syncViews = Array.make(
    ...
    CommentsContract.ActiveCustomerOrderView,
    ...
    InvoicesContract.ActiveCustomerOrderView,
    OrdersContract.ActiveView,
    OrdersContract.ActiveCustomerView,
    OrdersContract.ActiveManagerAuthorizedSharedAccountView,
    OrderObjectMetadataContract.ActiveView,
    OrderObjectMetadataContract.ActiveCustomerView,
    OrderObjectMetadataContract.ActiveManagerAuthorizedSharedAccountView,
