...
class Config(pulumi.ComponentResource):
    def __init__(self, args: ConfigArgs, opts: Optional[pulumi.ResourceOptions] = None):
        ...
        self.__papercut_tailscale_service = aws.appconfig.ConfigurationProfile(
            resource_name="PapercutTailscaleService",
        ...
        self.__tailscale_oauth_client = aws.appconfig.ConfigurationProfile(
            resource_name="TailscaleOauthClient",
            args=aws.appconfig.ConfigurationProfileArgs(
                application_id=self.__application.id,
                location_uri="hosted",
                type="AWS.Freeform",
        ...
        self.register_outputs(
            {
                ...
                "frps_profile": self.__papercut_tailscale_service.id,
    ...
    def dynamic(self):
        return Dynamic(
            ...
            profiles=Profiles(
                papercut_tailscale_service=self.__papercut_tailscale_service,
                papercut_web_services_auth_token=self.__papercut_web_services_auth_token_profile,
                tailscale_oauth_client=self.__tailscale_oauth_client,
            )
        )
