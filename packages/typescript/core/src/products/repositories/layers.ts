...
export const repositoryLayer = makeRepository.pipe(Layer.effect(ProductsRepository));
...
export const syncRepositoryLayer = makeSyncRepository.pipe(Layer.effect(ProductsSyncRepository));
