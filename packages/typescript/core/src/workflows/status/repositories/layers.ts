...
import { WorkflowStatusesRepository, WorkflowStatusesSyncRepository } from ".";
...
export const repositoryLayer = makeRepository.pipe(Layer.effect(WorkflowStatusesRepository));
