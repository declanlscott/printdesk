...
export namespace PolicyHandlers {
  export const registry = new Handler.Registry()
    ...
    .handle(OrderObjectMetadataContract.isCustomer)
    .handle(OrderObjectMetadataContract.isManager)
    .handle(OrderObjectMetadataContract.isCustomerOrManager)
    .handle(OrderObjectMetadataContract.isManagerAuthorized)
    .handle(OrderObjectMetadataContract.canEdit)
    .handle(OrderObjectMetadataContract.canDelete)
