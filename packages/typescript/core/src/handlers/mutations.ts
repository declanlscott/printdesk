...
export namespace MutationHandlers {
  export const registry = new Handler.Registry()
    ...
    .handle(OrdersContract.draft)
    .handle(OrdersContract.submit)
    ...
    .handle(OrderObjectMetadataContract.create)
    .handle(OrderObjectMetadataContract.transitionStatus)
    .handle(OrderObjectMetadataContract.delete_)
