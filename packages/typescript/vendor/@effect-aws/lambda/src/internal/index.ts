...
const isEventBridgeEvent = (event: unknown): event is EventBridgeEvent<string, unknown> =>
  !!(
...
const isSelfManagedKafkaEvent = (event: unknown): event is SelfManagedKafkaEvent =>
