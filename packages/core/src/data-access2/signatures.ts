...
export class PolicySignatures extends Effect.Service<PolicySignatures>()(
  "@printdesk/core/data-access/PolicySignatures",
  {
    accessors: true,
    succeed: {
      registry: new DataAccess.PolicySignatureRegistry()
...
export class MutationSignatures extends Effect.Service<MutationSignatures>()(
  "@printdesk/core/data-access/MutationSignatures",
  {
    accessors: true,
    effect: Effect.gen(function* () {
      ...
      const registry = new DataAccess.MutationSignatureRegistry({ session })
