...
import { SharedAccountsRepository, SharedAccountsSyncRepository } from ".";
...
export const repositoryLayer = makeRepository.pipe(Layer.effect(SharedAccountsRepository));
