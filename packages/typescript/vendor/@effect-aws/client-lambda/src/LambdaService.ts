 ...
 * @category models
 */
export class LambdaService extends Context.Service<LambdaService, LambdaService$>()(
  "@effect-aws/client-lambda/LambdaService",
) {
  public static readonly defaultLayer = Layer.effect(this, makeLambdaService).pipe(
    Layer.provide(Instance.layer),
  );
  public static readonly layer = (config: LambdaService.Config) =>
